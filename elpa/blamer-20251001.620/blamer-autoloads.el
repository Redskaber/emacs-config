...
This is a minor mode.  If called interactively, toggle the `Blamer mode'
...
evaluate the variable `blamer-mode'.
...
With prefix ARG, enable Global Blamer mode if ARG is positive; otherwise,
disable it.
...
Blamer mode is enabled in all buffers where `(lambda nil (unless blamer-mode
(blamer-mode)))' would do it.
