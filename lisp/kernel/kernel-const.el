;;; kernel-const.el --- Kernel constants -*- lexical-binding: t; -*-
;;; Commentary:
;;; Immutable path/layout constants for local Emacs runtime.
;;; Code:
...
(defconst my/etc-dir (expand-file-name "etc/" user-emacs-directory)
  "Directory for local templates, scripts, dictionaries, etc.")
...
(provide 'kernel-const)
;;; kernel-const.el ends here
